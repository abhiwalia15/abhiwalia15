...
- 💬 Ask me about **``` pd.dataframe(columns=['Data Science', 'Machine Learning', 'Computer Vision', 'Data Analysis', 'Technical Writing', 'Open-Source']) ```**

- 📫 Have an amazing AI project idea? Contact me on my email **waliamrinal@gmail.com** or get in touch through my **[LinkedIn.](https://medium.com/@waliamrinal/list/opensource-blogs-b68cf331d37d)** I promise I get back to all messages within 24 hrs
...
<code>git commit -am "Almost everything about Data Science, Data Analytics, Machine Learning Modeling, Algorithm Optimization, & Anything and Everything possible to build using below tech stack👇"</code> :grin:
...
<div class="row">
  ...
  <div class="column">
    <p><img align="right" src="https://github-readme-streak-stats.herokuapp.com/?user=abhiwalia15&theme=shades-of-purple" alt="abhiwalia15" style="width:45%"/></p>
  </div>
</div>
